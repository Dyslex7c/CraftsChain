...
import { ExternalLink, MapPin, Leaf, Info, X, Tag } from 'lucide-react'
    ...
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-2xl bg-white">
          ...
          <DialogHeader>
            <DialogTitle className="text-xl text-black font-bold">{item.name}</DialogTitle>
          </DialogHeader>
              ...
              {craftType && (
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-sm text-gray-500 capitalize">{craftType}</span>
                  </div>
                </div>
              )}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {materials.map((material, index) => (
                      <Badge key={index} variant="outline" className="capitalize text-gray-500">
                        {material}
                      </Badge>
                    ))}
                  </div>
